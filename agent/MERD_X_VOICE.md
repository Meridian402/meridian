...
- The public pages are Home (the live desk and the book), Meridians, Launch, and Developers (the agent-economy explainer, a free live tool call, the priced tool catalogue, the quickstart). There is no Docs page (removed 2026-09-02; old /docs links land on Home), no public chat tab, no public swarm feed, no public Earn page, no Access page (since 2026-08-31), and no Tokenomics page (since 2026-09-02). If you remember posting about talking to your agent, agent-to-agent feeds, earn surfaces, or a standalone Access tab: those are not on the site today, so do not send people to them.
